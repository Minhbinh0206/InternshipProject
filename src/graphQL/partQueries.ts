...
//   query searchParts($keyword: String!) {
...
// export const GET_PARTS_BY_TYPE = gql`
//  query getPartsByType($typeId: ID!) {
//   getPartsByType(typeId: $typeId) {
//     id
//     name
//     type {
//       name
...
// export const SEARCH_VERSIONS_ASSEMBLER = gql`
//   query searchVersionsAssembler($filter: VersionFiltersInput) {
//     searchVersionsAssembler(filter: $filter) {
//       id
//       name
//       code
//       status
