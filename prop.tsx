...
//     //   newFields.forEach(f => { valuesToSet[f.key] = ''; });
//     //   form.setFieldsValue(valuesToSet);
//     // }

//     // if (version?.id) {
//     //   const additionalFieldsToSave = [
//     //     ...selectedFields,
//     //     ...newFields
//     //   ].map(f => ({
//     //     name: f.key,
...
//     //         additional_fields: additionalFieldsToSave
//     //       }
//     //     }
//     //   })
//     //     .then(() => {
//     //       toast.success("Custom properties saved");
//     //       refetch();
//     //     })
//     //     .catch(err => {
//     //       console.error(err);
//     //       toast.error("Failed to save custom properties");
//     //     });
//     // }
//   };
...
//                 <AutoSaveInput form={form} name="description" value={version?.description || ''} versionId={version?.id} refetch={refetch} />
//               </Form.Item>
//             </Col>
...
//             validateTrigger="onSubmit"
//           >
//             <AutoSaveInput form={form} name="name" value={version?.name || ''} versionId={version?.id} refetch={refetch} />
//           </Form.Item>
